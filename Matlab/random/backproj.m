...
%   I = BACKPROJ(R,THETA) reconstructs the image I from projection 
...
%   speed up the FFT.
%
%   I = BACKPROJ(R,THETA,INTERP,FILTER,D,N) specifies parameters 
...
%
%   If you specify N, BACKPROJ reconstructs a smaller or larger portion of 
...
%   image.  
%
%   [I,H] = BACKPROJ(...) returns the frequency response of the filter
%   in the vector H.
%
%   Class Support
%   -------------
...
%       P = phantom(128);
%       R = radon(P,0:179);
%       I = backproj(R,0:179,'nearest','Hann');
%       imshow(P); figure; imshow(I);
%
%   See also IRADON, RADON, PHANTOM.
%
%  Oliver Wieben - 23Mar01
%  This code is based on the MATLAB-file IRADON with added support
%   for unfiltered back-projection.
